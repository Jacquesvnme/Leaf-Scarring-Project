...
def process_image(image_path):
    ...
    cv2.imwrite("Generated Images/HSV_Image.png", hsv)
    ...
    cv2.imwrite("Generated Images/Green_Mask.png", green_mask)
    yellow_mask = cv2.inRange(hsv, lower_Unhealthy, upper_Unhealthy)
    cv2.imwrite("Generated Images/Yellow_Mask.png", yellow_mask)
    brown_mask = cv2.inRange(hsv, lower_Scar, upper_Scar)
    cv2.imwrite("Generated Images/Brown_Mask.png", brown_mask)
    ...
    cv2.imwrite("Generated Images/Leaf_Mask.png", leaf_mask)
